...
import { useRef, useEffect, useCallback, useState, type ElementType, type ReactNode, type CSSProperties } from 'react'
...
const DEFAULT_GLOW_COLOR = '224, 120, 48'
...
function GlobalSpotlight({ gridRef, disableAnimations = false, enabled = true, spotlightRadius = DEFAULT_SPOTLIGHT_RADIUS, glowColor = DEFAULT_GLOW_COLOR }: GlobalSpotlightProps) {
    ...
    const onMove = (e: MouseEvent) => {
      ...
      const targetOpacity = minDist <= proximity
        ...
        : minDist <= fadeDistance
          ? ((fadeDistance - minDist) / (fadeDistance - proximity)) * 0.6
          : 0
...
export function MagicBento({
  ...
  return (
    <>
      ...
      <div className="magic-bento-light card-grid bento-section" ref={gridRef}>
