...
export const SERVICE_AREA_SECTION = {
  headline: 'Serving All 50 States',
  subheadline:
...
export const SERVICE_AREAS = [
  ...
  { city: 'Round Rock', state: 'TX', zips: ['78664', '78665', '78681'] },
  { city: 'Cedar Park', state: 'TX', zips: ['78613', '78613'] },
  { city: 'Georgetown', state: 'TX', zips: ['78626', '78628', '78633'] },
  { city: 'Pflugerville', state: 'TX', zips: ['78660'] },
  { city: 'Leander', state: 'TX', zips: ['78641', '78646'] },
] as const
